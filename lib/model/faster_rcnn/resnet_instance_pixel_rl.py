...
class resnet(_fasterRCNN):
  def __init__(self, classes, num_layers, pretrained=False, class_agnostic=False,ic=False,S_agent=False,T_agent=False,ts=0.5,tt=0.5,select_num=3,candidate_num=16):
  ...
  def _init_modules(self):
    ...
    #action_num = int(cfg.TRAIN.RPN_POST_NMS_TOP_N_TARGET/cfg.CANDIDATE_NUM)
    action_num = self.candidate_num
    print("action_num",action_num)
    state_size = self.candidate_num*2048
