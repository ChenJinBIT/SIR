...
def parse_args():
    ...
    parser.add_argument('--ic', dest='ic',
                        help='whether use context vector with pixelD',
                        action='store_true')
    ...
    parser.add_argument('--bs', dest='batch_size',
                        help='batch_size',
                        default=1, type=int)
    parser.add_argument('--select_num', dest='select_num',
                        help='select_num',
                        default=3, type=int)
    parser.add_argument('--candidate_num', dest='candidate_num',
                        help='candidate_num',
                        default=16, type=int)
    parser.add_argument('--cag', dest='class_agnostic',
                        help='whether perform class_agnostic bbox regression',
                        action='store_true')
    parser.add_argument('--ts', dest='threshold_dqn_s',
                        help='threshold_dqn_s',
                        default=0.5, type=float)
    parser.add_argument('--tt', dest='threshold_dqn_t',
                        help='threshold_dqn_t',
                        default=0.5, type=float)
    ...
    parser.add_argument('--proposal_dir', dest='proposal_dir',
                        help='directory to save proposals', default="./data/showagent",
                        type=str)
...
def set_dataset_args(args, test=False):
    if not test:
        if args.dataset == "pascal_voc":
            ...
            args.imdb_name = "sim10k_trainval"
            args.imdbval_name = "sim10k_trainval"
        ...
        if args.dataset_t == "water":
            ...
            args.imdbval_name_target = "water_test"
        ...
        if args.dataset == "pascal_voc":
            ...
            args.set_cfgs = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES',
                                    '20']
        elif args.dataset == "pascal_voc_showagent":
            args.imdb_name = "voc_2007_trainval+voc_2012_trainval"
            args.imdbval_name = "voc_2012_trainval"
            args.set_cfgs = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]']
        elif args.dataset == "kitti_showagent":
            args.imdb_name = "kitti_trainval"
            args.imdbval_name = "kitti_trainval"
            args.set_cfgs = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]']

        if args.dataset_t == "clipart_showagent":
            args.imdb_name_target = "clipart_trainval"
            args.imdbval_name_target = "clipart_trainval"
            args.set_cfgs_target = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES',
                                    '20']
        elif args.dataset_t == "cityscape_car_showagent":
            args.imdb_name_target = "cityscape_car_trainval"
            args.imdbval_name_target = "cityscape_car_trainval"
            args.set_cfgs_target = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES',
                                    '20']
