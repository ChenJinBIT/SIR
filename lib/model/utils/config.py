...
__C.CANDIDATE_NUM = 16

__C.SELECTED_NUM = 3
__C.epsilon_start = 0.9

__C.epsilon_final = 0.01

__C.replace_target_iter = 48

__C.REPLAY_MEMORY = 200

__C.BATCH_SIZE_DQN = 64

__C.epsilon_decay = 240000
...
## Number of top scoring boxes to keep after applying NMS to RPN proposals
__C.TEST.RPN_POST_NMS_TOP_N = 128
...
__C.RESNET_PATH50 = "./data/pretrained_model/resnet50_caffe.pth"
#
# MISC
#
